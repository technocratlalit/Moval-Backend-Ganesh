                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590" >
                                <tr>
                                    <td align="left" style="color: #757575; font-size: 16px;line-height: 24px;padding: 10px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            <a href="{{$maildata['applink']}}" style="display: block; border-style: none !important; border: 0 !important;"><img width="120" border="0" style="display: block; width: 120px;" src="http://archiveinfotechdevelopers.com/moval-admin/api/storage/images/google_play_download_btn.png" alt="Download Now" /></a>
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
