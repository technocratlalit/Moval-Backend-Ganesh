                                ...
                                <tr>
                                    <td align="left" style="color: #757575; font-size: 16px;line-height: 24px;padding: 10px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Thanks for joining us at Moval.
                                            Your feedback helps us to make sure that we’re delivering exactly what customers want. Just hit reply and let us know.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            For any query, please contact us at {{$maildata['contactEmail']}}
                                        </p>
