                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590" style="background-color: #ff4747;">
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="300" border="0" style="display: block; width: 300px;" src="{{asset('public/logo/logo.png')}}" alt="Moval" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr>
                                    <td align="left" style="color: #757575; font-size: 16px;line-height: 24px;padding: 10px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            Welcome to Moval! Your account is activated and login credentials are as below:
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;color: #4a4a4a">
                                            User ID: <b>{{$maildata['userId']}}</b>
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;color: #4a4a4a">
                                            Password: <b>{{$maildata['password']}}</b>
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            You are requested to change your password immediately once you login.
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;color: #4a4a4a">
                                            <b>Note: Do not share your account related information with anyone.</b>
                                        </p>
                                        <p style="line-height: 10px; margin-bottom:20px;">
                                            Click here to login
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                            <a href="{{$maildata['adminLoginLink']}}">CHECK NOW</a>
                                        </p>
                                        <p style="line-height: 24px; margin-bottom:20px;">
                                        ...
                                        <p style="line-height: 24px; margin-bottom:20px;color: #4a4a4a;background-color: antiquewhite;">
                                            <b>All photographs / Video of the respective Jobs will be deleted from the system after {{$maildata['months']}} months from the jobs completion date</b>
                                            <!--<b>All photographs will be deleted from the system after {{$maildata['months']}} months from the job completion date.</b>-->
                                        </p>
        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590" style="background-color:#f0f0f0">
                    <tr>
                        <td align="center"  style="color: #aaaaaa; font-size: 13px;line-height: 50px;text-align: center;">
