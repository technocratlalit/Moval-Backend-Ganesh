...
<table width="100%" align="center" id="design" style="font-size: 14px;">
        ...
        @unless(in_array($value, $uniqueGstRates))
            ...
            @if($lossAssessment[0]['MutipleGSTonParts']==1 && $lossAssessment[0]['GSTAssessedPartsPer'] !=0)
                <tr>
                    ...
                    <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalMetalPartsAmount,2, '.', '') }}</td>
    ...
    <tr>
        ...
        <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format_custom(round($grandtotalDepAmount),2, '.', '') }}</td>
        <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold; ">{{ number_format_custom(round($grandtotalAfterDepAmount),2, '.', '') }}</td>
        ...
        @unless(in_array($value, $uniqueGstRates))
            ...
            @if($lossAssessment[0]['MutipleGSTonParts']==1 && $lossAssessment[0]['GSTAssessedPartsPer'] !=0)
                <tr>
                    <td align="center" valign="top" style="padding: 0px 3px;  border-left: 1px solid #000;">{{$index + 1 }}</td>
                    <td align="center" valign="top" style="padding: 0px 3px; ">{{$value}}</td>
                    <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalGlassPartAmount) }}</td>
                    <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalDepAmount) }}</td>
                    <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalAmtAfterDep) }}</td>
                    @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
                        <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalGSTOrIGSTAmtPer) }}</td>
                    @else
                        <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
                    @endif
                    @if($lossAssessment[0]['IGSTonPartsAndLab'] ==1)
                    ...
                    @else
                        <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
                    @endif
                    <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalWithGSTorIGSTAmount) }}</td>
                </tr>
            @endif
            @php
...
<table width="100%" align="center" id="design" style="font-size: 14px;">
        ...
        @unless(in_array($value, $uniqueGstRates))
            ...
            @if($lossAssessment[0]['MutipleGSTonParts']==1 && $lossAssessment[0]['GSTAssessedPartsPer'] !=0)
                <tr>
                    ...
                    <td align="center" valign="top" style="padding: 0px 3px; ">{{$value}}</td>
                    <td align="right" valign="top"
                        style="padding: 0px 3px; ">{{ number_format_custom($totalRubberPartAmount,2, '.', '') }}</td>
                    <td align="right" valign="top"
    ...
    @if($lossAssessment[0]['MutipleGSTonParts']==0 || $lossAssessment[0]['GSTAssessedPartsPer'] ==0)
        <tr>
            ...
            <td align="center" valign="top"
                style="padding: 0px 3px; ">{{ $lossAssessment[0]['GSTAssessedPartsPer'] }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalRubberPartAmount,2, '.', '') }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalDepAmount,2, '.', '') }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalAmtAfterDep,2, '.', '') }}</td>
            @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
                <td align="right" valign="top"
...
<table width="100%" align="center" id="design" style="font-size: 14px;">
        ...
        @unless(in_array($value, $uniqueGstRates))
            ...
            @if($lossAssessment[0]['MutipleGSTonParts']==1 && $lossAssessment[0]['GSTAssessedPartsPer'] !=0)
                <tr>
                    ...
                    <td align="center" valign="top" style="padding: 0px 3px; ">{{$value}}</td>
                    <td align="right" valign="top"
                        style="padding: 0px 3px; ">{{ number_format_custom($totalFibrePartAmount,2, '.', '') }}</td>
                    <td align="right" valign="top"
                        style="padding: 0px 3px; ">{{ number_format_custom($totalDepAmount,2, '.', '') }}</td>
                    <td align="right" valign="top"
                        style="padding: 0px 3px; ">{{ number_format_custom($totalAmtAfterDep,2, '.', '') }}</td>
    ...
    @if($lossAssessment[0]['MutipleGSTonParts']==0 || $lossAssessment[0]['GSTAssessedPartsPer'] ==0)
        <tr>
            ...
            <td align="center" valign="top"
                style="padding: 0px 3px; ">{{ $lossAssessment[0]['GSTAssessedPartsPer'] }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalFibrePartAmount,2, '.', '') }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalDepAmount,2, '.', '') }}</td>
            <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format_custom($totalAmtAfterDep,2, '.', '') }}</td>
            @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
                <td align="right" valign="top"
