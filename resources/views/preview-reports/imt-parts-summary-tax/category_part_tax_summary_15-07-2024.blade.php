...
<table width="100%" align="center" id="design">
    ...
    <tr>
        <td align="left" valign="top"
            style="font-weight: bold; border-right:none; border-bottom:none; padding: 3px 0px;"><span
                    style="text-decoration:underline;">PARTS TAX SUMMARY</span></td>
    </tr>

    <tr>
        <td align="left" valign="top"
            style="padding: 0px 3px; border: none; border-bottom: 2px solid #000; font-weight: bold;">Metal
        </td>
    </tr>
    </tbody>
</table>
            ...
            @if($lossAssessment[0]['MutipleGSTonParts']==1 && $lossAssessment[0]['GSTAssessedPartsPer'] !=0)
                <tr>
                    ...
                    <td align="right" valign="top"
                        style="padding: 0px 3px; ">{{ number_format_custom($totalMetalPartsAmount,2) }}</td>
                    <td align="right" valign="top"
