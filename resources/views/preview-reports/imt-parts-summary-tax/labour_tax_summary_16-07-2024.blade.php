...
<table width="100%" align="center" id="design">
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @endphp
         ...
         <td align="center" valign="top" style="padding: 0px 3px;  border-left: 1px solid #000;">{{$indexCounter}}</td>
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">{{  number_format($totalAssLabAmount ,2)}}</td>
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @foreach($allLabourCharges as $detail)
        ...
        @if($detail['gst'] == $value && ($detail['imt_23'] == null || $detail['imt_23'] == "No")) {{-- Check if GST rate matches --}}
          @if(empty($detail['quantities'])){
            @php
                $totalEstlabAmt += !empty($detail['est_lab']) ? $detail['est_lab'] : 0; // Sum up estimated amount
                $totalAsslabAmt += !empty($detail['ass_lab']) ? $detail['ass_lab'] : 0; 
        ...
        @if(isset($detail['quantities']))
            @foreach($detail['quantities'] as $partQuantity)
            @if($partQuantity['gst'] == $value && ($partQuantity['imt_23'] == null || $partQuantity['imt_23'] == "No"))
                    @php
                        $totalEstlabAmt += !empty($partQuantity['est_lab']) ? $partQuantity['est_lab'] : 0; // Sum up estimated amount
                        $totalAsslabAmt += !empty($partQuantity['ass_lab']) ? $partQuantity['ass_lab'] : 0; 
                        $totalPaintinglabAmt += !empty($partQuantity['painting_lab']) ? $partQuantity['painting_lab'] : 0;
    ...
    @endphp
       <tr>
          ...
          <td align="center" valign="top" style="padding: 0px 3px;">{{$value}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalPaitntingLabAmount ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalDepHalfAmt ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalPaintingAmtAfterDep ,2)}}</td>
        @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
          <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format($totalGSTOrIGSTAmtPer ,2)}}</td>
        @else
        <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
    ...
    @endforeach 
        <tr>
          <td align="center" valign="top" style="padding: 0px 3px; font-weight: bold; border-left: 1px solid #000;" colspan="2">Grand Total</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($grandtotalPaintingAmount ,2) }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format($grandtotalPaintingDepAmount ,2)  }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format($grandtotalPaintingAfterDepAmount ,2) }}</td>
        @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
        <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($grandtotalPaintingGSTOrIGSTAmtPer ,2) }}</td>
        @else
            <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
        @endif
            @if($lossAssessment[0]['IGSTonPartsAndLab'] ==1)
        ...
        @else
            <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
        @endif
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($grandtotalPaintingWithGSTorIGSTAmount ,2) }}</td>
        </tr>
      </tbody>
    </table>
...
@if($lossAssessment[0]['IMTPaintingLabAss'] != 0.00)
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @foreach($allLabourCharges as $detail)
        @if($detail['gst'] == $value && $detail['imt_23'] == "Yes") {{-- Check if GST rate matches --}}
          @if(empty($detail['quantities'])){
                @php
                    $totalEstlabAmt += !empty($detail['est_lab']) ? $detail['est_lab'] : 0; // Sum up estimated amount
                    $totalAsslabAmt += !empty($detail['ass_lab']) ? $detail['ass_lab'] : 0; 
        ...
        @if(isset($detail['quantities']))
            @foreach($detail['quantities'] as $partQuantity)
            @if($partQuantity['gst'] == $value && $partQuantity['imt_23'] == "Yes")
                    @php
                        $totalEstlabAmt += !empty($partQuantity['est_lab']) ? $partQuantity['est_lab'] : 0; // Sum up estimated amount
                        $totalAsslabAmt += !empty($partQuantity['ass_lab']) ? $partQuantity['ass_lab'] : 0; 
                        $totalPaintinglabAmt += !empty($partQuantity['painting_lab']) ? $partQuantity['painting_lab'] : 0;
    ...
    @endphp
       <tr>
          <td align="center" valign="top" style="padding: 0px 3px; border-left: 1px solid #000;">{{ $imtindexCounter }}</td>
          <td align="center" valign="top" style="padding: 0px 3px;">{{$value}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalPaitntingLabAmount ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalDepHalfAmt ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalPaintingAmtAfterDep ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($IMTDepAmount ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($paintingAmtAfterIMTDep ,2)}}</td>
        @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
          <td align="right" valign="top" style="padding: 0px 3px; ">{{ number_format($totalGSTOrIGSTAmtPer ,2)}}</td>
        @else
        <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
    ...
    @endforeach 
        <tr>
          <td align="center" valign="top" style="padding: 0px 3px; font-weight: bold; border-left: 1px solid #000;" colspan="2">Grand Total</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format(round($grandtotalPaintingAmount) ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format(round($grandtotalPaintingDepAmount) ,2) }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format(round($grandtotalPaintingAfterDepAmount) ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format(round($grandIMTDepAmount) ,2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{  number_format(round($grandPaintingAmtAfterIMTDep) ,2)}}</td>
        @if(($lossAssessment[0]['IGSTonPartsAndLab'] !=1 || $lossAssessment[0]['IGSTonPartsAndLab']==null))
        <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format(round($grandtotalPaintingGSTOrIGSTAmtPer) ,2)}}</td>
        @else
            <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
        @endif
            @if($lossAssessment[0]['IGSTonPartsAndLab'] ==1)
        ...
        @else
            <td align="right" valign="top" style="padding: 0px 3px; ">0.00</td>
        @endif
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format(round($grandtotalPaintingWithGSTorIGSTAmount) ,2)}}</td>
        </tr>
      </tbody>
    </table>
@endif
