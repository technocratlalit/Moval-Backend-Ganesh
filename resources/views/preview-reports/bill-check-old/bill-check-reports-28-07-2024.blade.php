                ...
                <tbody>
                    ...
                    @if(is_array($alldetails))
                        ...
                        @foreach($alldetails as $index => $detail)
                            @if(isset($detail['category']) && ($detail['category'] != null || $detail['category'] !="") && ($detail['ass_amt'] != null || $detail['ass_amt'] !=""))
                                @php
                                ...
                                <tr>
                                    ...
                                    <td align="left" valign="top">{{ $detail['description'] }}</td>
                            ...
                            @if (!empty($detail['quantities']))
                                @foreach($detail['quantities'] as $quantityIndex => $quantity)
                                    @if(isset($quantity['category']) && ($quantity['category'] != null || $quantity['category'] !="") && ($quantity['ass_amt'] != null || $quantity['ass_amt'] != ""))
                                        @php
                                            $subPartUniqueValue[]= $quantity['gst'];
                                            $GSTBilledPartPerAmt += $quantity['billed_part_amt'];
                                        @endphp
                                        <tr>
                                            <td align="left" valign="top" style="font-size: 12px; font-style: italic; padding-left: 5px">{{ $indexCounter }}.{{ $quantityIndex + 1 }}</td>
                                            <td align="left" valign="top" style="font-size: 12px; font-style: italic; padding-left: 5px">{{ $quantity['description'] }}</td>
                                            ...
                                            <td align="center" valign="top" style="font-size: 12px; font-style: italic; padding-left: 5px">{{ $indexCounter }}.{{ $quantityIndex + 1 }}</td>
                        ...
                        @if(($lossAssessment[0]['MultipleGSTonBilled']==0 && $lossAssessment[0]['GSTBilledPartPer']==0) || ($lossAssessment[0]['MultipleGSTonBilled']==1 && $lossAssessment[0]['GSTBilledPartPer']==0) || ($lossAssessment[0]['MutipleGSTonParts']==1 && ($lossAssessment[0]['GSTAssessedPartsPer'] ==0 || $lossAssessment[0]['GSTAssessedPartsPer'] ==null)) || ($lossAssessment[0]['MutipleGSTonParts']==0 && ($lossAssessment[0]['GSTAssessedPartsPer'] ==0 || $lossAssessment[0]['GSTAssessedPartsPer'] ==null)) || ($lossAssessment[0]['MultipleGSTonBilled']==0 && $lossAssessment[0]['GSTBilledPartPer'] !=0) || ($lossAssessment[0]['MutipleGSTonParts']==0 && ($lossAssessment[0]['GSTAssessedPartsPer'] !=0 || $lossAssessment[0]['GSTAssessedPartsPer'] !=null)))
                            @if(($lossAssessment[0]['GSTBilledPartPer'] == $lossAssessment[0]['GSTAssessedPartsPer']) && ($lossAssessment[0]['MutipleGSTonParts']==0 && $lossAssessment[0]['MultipleGSTonBilled']==1))
{{--                                <tr>--}}
{{--                                    <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTBilledPartPer'] }}%</td>--}}
{{--                                    <td align="right" valign="top">0.00</td>--}}
{{--                                    <td align="right" valign="top">{{ number_format_custom(($totalAddGSTAssessedAmt * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) }}</td>--}}
{{--                                </tr>--}}
                                @php
                                    $totalAmtWithGSTAssessed = ($totalAddGSTAssessedAmt * $lossAssessment[0]['GSTAssessedPartsPer'] / 100);
                                @endphp
                            @elseif(($lossAssessment[0]['GSTBilledPartPer'] == $lossAssessment[0]['GSTAssessedPartsPer']) && ($lossAssessment[0]['MultipleGSTonBilled']==0 && $lossAssessment[0]['MutipleGSTonParts']==1))
{{--                                <tr>--}}
{{--                                    <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTBilledPartPer'] }}%</td>--}}
{{--                                    <td align="right" valign="top">{{ number_format_custom(($totalAddGSTBilledAmt * $lossAssessment[0]['GSTBilledPartPer'] / 100), 2) }}</td>--}}
{{--                                    <td align="right" valign="top">0.00</td>--}}
{{--                                </tr>--}}
                                @php
                                    $totalAmtWithGSTBilled = ($totalAddGSTBilledAmt * $lossAssessment[0]['GSTBilledPartPer'] / 100);
                                @endphp
                            @elseif($lossAssessment[0]['GSTBilledPartPer'] == $lossAssessment[0]['GSTAssessedPartsPer'] && ($lossAssessment[0]['MultipleGSTonBilled']==0 && $lossAssessment[0]['MutipleGSTonParts']==0))
{{--                                <tr>--}}
{{--                                    <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTBilledPartPer'] }}%</td>--}}
{{--                                    <td align="right" valign="top">{{ number_format_custom(($totalAddGSTBilledAmt * $lossAssessment[0]['GSTBilledPartPer'] / 100), 2) }}</td>--}}
{{--                                    <td align="right" valign="top">{{ number_format_custom(($totalAddGSTAssessedAmt * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) }}</td>--}}
{{--                                </tr>--}}
                            ...
                            @else
                                ...
                                @if($lossAssessment[0]['GSTBilledPartPer'] != 0 && $lossAssessment[0]['MultipleGSTonBilled'] == 0)
{{--                                    <tr>--}}
{{--                                        <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTBilledPartPer'] }}%</td>--}}
{{--                                        <td align="right" valign="top">{{ number_format_custom(($totalAddGSTBilledAmt * $lossAssessment[0]['GSTBilledPartPer'] / 100), 2) }}</td>--}}
{{--                                        <td align="right" valign="top">0.00</td>--}}
...
{{--                                    </tr>--}}
                                ...
                                @if($lossAssessment[0]['GSTBilledPartPer'] == 0 && $lossAssessment[0]['MultipleGSTonBilled'] == 1)
                                    <tr>
                                        <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTBilledPartPer'] }}%</td>
                                        <td align="right" valign="top">{{ number_format_custom(($totalAddGSTBilledAmt * $lossAssessment[0]['GSTBilledPartPer'] / 100), 2) }}</td>
                                        <td align="right" valign="top">0.00</td>
                                ...
                                @if($lossAssessment[0]['GSTAssessedPartsPer'] != 0 && $lossAssessment[0]['MutipleGSTonParts'] == 0)
                                    <tr>
                                        <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTAssessedPartsPer'] }}%</td>
                                        <td align="right" valign="top">0.00</td>
                                        <td align="right" valign="top">{{ number_format_custom(($totalAddGSTAssessedAmt * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) }}</td>
                                    </tr>
                                    @php
                                ...
                                @if(($lossAssessment[0]['GSTAssessedPartsPer'] == "0") && ($lossAssessment[0]['MutipleGSTonParts'] == 1))
                                    <tr>
                                        <td align="left" valign="top" colspan="8">Add GST @ {{ $lossAssessment[0]['GSTAssessedPartsPer'] }}%</td>
                                        <td align="right" valign="top">0.00</td>
                                        <td align="right" valign="top">{{ number_format_custom(($totalAddGSTAssessedAmt * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) }}</td>
                        ...
                        <tr>
                            ...
                            <td align="right" valign="top" style="font-weight: bold;">{{ number_format_custom(($totalAmtWithGSTBilled + $totalBilledAmt), 2) }}</td>
                            <td align="right" valign="top" style="font-weight: bold;">{{ number_format_custom(($totalAmtWithGSTAssessed + $totalAssessedAmt), 2) }}</td>
                        </tr>
                    @endif
                </tbody>
            </table>
