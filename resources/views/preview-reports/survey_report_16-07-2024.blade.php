    ...
    <div style="text-align: center;font-weight: bold; font-family: 'Verdana' !important; ">MOTOR ({{ ($policyDetails->claim_type == 1) ? 'FINAL' : 'SPOT' }}) SURVEY REPORT</div>
      ...
      <div>
        ...
        <tr>
          ...
          <td align="left" valign="top" style="width: 54%; padding-top: 3px;">{{ !empty($policyDetails->policy_type) ? $policyDetails->policy_type : '' }}</span>
          </td>
        </tr>
        @endif
        ...
        <tr>
          ...
          <td align="left" valign="top" style="padding-top: 3px;">:</td>
          <td align="left" valign="top" style="padding-top: 3px;">{{ !empty($policyDetails->status_of_64vb) ? $policyDetails->status_of_64vb : '' }}</span>
          </td>
        </tr>  
        @endif
        @if(isset($policyDetails->status_of_64vb) && trim($policyDetails->status_of_64vb) !== '')
        <tr>
          ...
          <td align="left" valign="top" style="padding-top: 3px;">:</td>
          <td align="left" valign="top" style="padding-top: 3px;">{{ !empty($policyDetails->status_of_pre_insp) ? $policyDetails->status_of_pre_insp : '' }}</span>
          </td>
        </tr>
        @endif
        ...
        <tr>
          ...
          <td align="left" valign="top" style="padding-top: 3px;">:</td>
          <td align="left" valign="top" style="padding-top: 3px;">{{ !empty($policyDetails->status_of_NCB) ? $policyDetails->status_of_NCB : '' }}</span>
          </td>
        </tr>
        @endif
        ...
        <tr>
          ...
          <td align="left" valign="top" style="padding-top: 3px;">:</td>
          <td align="left" valign="top" style="padding-top: 3px;">{{ !empty($policyDetails->payment_mode) ? $policyDetails->payment_mode : '' }}</span>
          </td>
        </tr>
        @endif
        ...
        <tr>
          ...
          <td align="left" valign="top" style="padding-top: 3px;">:</td>
          <td align="left" valign="top" style="padding-top: 3px;">{{ !empty($policyDetails->settlement_type) ? $policyDetails->settlement_type : '' }} </span>
          </td>
        </tr>
        @endif
...
@if(
 ...
 @if($lossAssessment[0]['GSTEstimatedPartsPer'] !=Null || $lossAssessment[0]['GSTAssessedPartsPer'] !=Null)
    ...
    @if($lossAssessment[0]['GSTEstimatedPartsPer']==0 && $lossAssessment[0]['GSTEstimatedPartsPer'] == $value)
        ...
        <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalMetalAmt + $totalPartMetalAmt, 2) }}</td>
        <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalRubberAmt + $totalPartRubberAmt, 2) }}</td>
        <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalGlassAmt + $totalPartGlassAmt, 2) }}</td>
        <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        @elseif($lossAssessment[0]['GSTAssessedPartsPer']==0 && $lossAssessment[0]['GSTAssessedPartsPer'] == $value)
        <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Total (Parts with GST {{ $value }}%)</td>
        <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalEstAmt, 2) }}</td>
      ...
      @endif
        ...
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($lossAssessment[0]['totalMetalAmt'] * $lossAssessment[0]['MetalDepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($lossAssessment[0]['totalRubberAmt'] * $lossAssessment[0]['RubberDepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($lossAssessment[0]['totalGlassAmt'] * $lossAssessment[0]['GlassDepPer']) / 100, 2) }}
          </td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">
            {{ number_format($lossAssessment[0]['totalMetalAmt'] - ($lossAssessment[0]['totalMetalAmt'] * $lossAssessment[0]['MetalDepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">
            {{ number_format($lossAssessment[0]['totalRubberAmt'] - ($lossAssessment[0]['totalRubberAmt'] * $lossAssessment[0]['RubberDepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">
            {{ number_format($lossAssessment[0]['totalGlassAmt'] - ($lossAssessment[0]['totalGlassAmt'] * $lossAssessment[0]['GlassDepPer']) / 100, 2) }}
          </td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        </tr>
        @php 
    ...
    @if($totalIMT23MetalAmt !=0 || $totalIMT23RubberAmt != 0)
        <tr>
          <td align="left" valign="top"   colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">
          Less Addl. Deduction of IMT Parts @ <span style="font-weight: bold;">{{$lossAssessment[0]['IMT23DepPer']}}%</span> (*)- Metal - <span style="font-weight: bold;">{{ number_format($totalIMT23MetalAmt - ($totalIMT23MetalAmt * $lossAssessment[0]['MetalDepPer']) / 100, 2) }}</span> Rub/Plast - <span style="font-weight: bold;">{{ number_format($totalIMT23RubberAmt - ($totalIMT23RubberAmt * $lossAssessment[0]['RubberDepPer']) / 100, 2) }}</span></td>
          <td align="right" valign="top" style="padding: 0px 3px;">-</td>
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($IMTMetalDepAmt * $lossAssessment[0]['IMT23DepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px;">
          {{ number_format(($IMTRubberDepAmt * $lossAssessment[0]['IMT23DepPer']) / 100, 2) }}
          </td>
          <td align="right" valign="top" style="padding: 0px 3px;">0.00</td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($subTotalIMTMetalAmt, 2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($subTotalIMTRubberAmt, 2)}}</td>
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($subTotalIMTGlassAmt, 2)}}</td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        </tr>
       @endif
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @foreach($alldetails as $detail)
     ...
     @if(($lossAssessment[0]['GSTEstimatedPartsPer']==0 || $lossAssessment[0]['GSTEstimatedPartsPer'] == NULL) && ($lossAssessment[0]['GSTAssessedPartsPer'] !=0 || $lossAssessment[0]['GSTAssessedPartsPer'] != NULL))
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($totalEstAmt * $lossAssessment[0]['GSTEstimatedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTMetalAmtAfterIMTDep * $value / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTRubberAmtAfterIMTDep * $value / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalGlassAmtAfterDep * $value / 100), 2) : '0.00' }}</td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
     @elseif(($lossAssessment[0]['GSTAssessedPartsPer']==0 || $lossAssessment[0]['GSTAssessedPartsPer'] == NULL) && ($lossAssessment[0]['GSTEstimatedPartsPer'] !=0 || $lossAssessment[0]['GSTEstimatedPartsPer'] != NULL))
      <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $value }}%</td>
      <td align="right" valign="top" style="padding: 0px 3px;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($totalEstAmt * $value / 100), 2) : '0.00' }}</td>
      <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTMetalAmtAfterIMTDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
      <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTRubberAmtAfterIMTDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
      <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalGlassAmtAfterDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
      <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
     @else
          <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $value }}%</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($totalEstAmt * $value / 100), 2) : '0.00' }}</td>
     ...
     <!--     <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $value }}%</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($lossAssessment[0]['total_EstAmt'] * $value / 100), 2) : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTMetalAmtAfterIMTDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTRubberAmtAfterIMTDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalGlassAmtAfterDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>-->
     <!--     <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>-->
     ...
     <!-- @elseif($lossAssessment[0]['GSTAssessedPartsPer']==0 && $lossAssessment[0]['GSTAssessedPartsPer'] == $value)-->
     <!--    <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $value }}%</td>-->
     <!--    <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalEstAmt * $value / 100), 2) : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalMetalAmt']) ? $lossAssessment[0]['totalMetalAmt'] : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalRubberAmt']) ? $lossAssessment[0]['totalRubberAmt'] : '0.00' }}</td>-->
     <!--     <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalGlassAmt']) ? $lossAssessment[0]['totalGlassAmt'] : '0.00' }}</td>-->
     <!--     <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>-->
    ...
    @foreach($lossAssessment as $row)
      <tr>
          ...
          @else
          <td align="left" valign="top" colspan="{{ $colspanValue + 6 }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $lossAssessment[0]['IGSTonPartsAndLab'] == 0 ? "GST" : "IGST" }} {{ $row['GSTEstimatedPartsPer'] }}%</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($lossAssessment[0]['total_EstAmt'] * $row['GSTEstimatedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">0.00</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">0.00</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">0.00</td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalMetalAmt']) ? number_format(($lossAssessment[0]['total_EstAmt'] * $row['GSTEstimatedPartsPer'] / 100), 2) : '0.00' }}</td>
          @else
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">0.00</td>
          @endif
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalMetalAmt']) ? number_format(($subTotalIMTMetalAmt * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalRubberAmt']) ? number_format(($subTotalIMTRubberAmt * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalGlassAmt']) ? number_format(($subTotalIMTGlassAmt * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
      </tr>
    @php 
     ...
     @php
      ...
      @endphp
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{number_format($subTotalEstimateAmt + (!empty($lossAssessment[0]['total_EstAmt']) ? $lossAssessment[0]['total_EstAmt'] : '0.00'), 2) }}</td>
          @else
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{number_format((!empty($lossAssessment[0]['total_EstAmt']) ? $lossAssessment[0]['total_EstAmt'] : '0.00'), 2) }}</td>
          @endif
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format((!empty($lossAssessment[0]['partMetalAssamount']) ? ($lossAssessment[0]['partMetalAssamount'] + $lossAssessment[0]['totalMetalIMTAmt']) : '0.00'), 2) }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format((!empty($lossAssessment[0]['partRubberAssamount']) ? ($lossAssessment[0]['partRubberAssamount'] + $lossAssessment[0]['totalRubberIMTAmt']) : '0.00'), 2) }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format((!empty($lossAssessment[0]['partGlassAssamount']) ? $lossAssessment[0]['partGlassAssamount'] : '0.00'), 2) }}</td>
          <!--<td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalMetalAmt + $subTotalIMTMetalAmt, 2)}}</td>-->
          <!--<td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalRubberAmt + $subTotalIMTRubberAmt, 2)}}</td>-->
          <!--<td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalGlassAmt + $subTotalIMTGlassAmt, 2)}}</td>-->
          <td align="center" valign="top" style="padding: 0px 3px;">&nbsp;</td>
        </tr>
      <!-- End Sub Total GST Part-->
        <tr>
          ...
          <td align="right" valign="top" colspan="5"
            style="padding: 0px 3px; border-bottom: 2px solid #000; border-top: 2px solid #000;font-weight: bold;">{{number_format(
 ...
 @if($lossAssessment[0]['GSTEstimatedPartsPer'] !=Null || $lossAssessment[0]['GSTAssessedPartsPer'] !=Null)
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @if($lossAssessment[0]['GSTEstimatedPartsPer']==0 && $lossAssessment[0]['GSTEstimatedPartsPer'] == $value)
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalGlassAmt + $totalPartGlassAmt, 2) }}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalFibreAmt + $totalPartFibreAmt, 2) }}</td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00")
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalReconditionAmt + $totalPartReconditionAmt, 2) }}</td>
          @endif
      @elseif($lossAssessment[0]['GSTAssessedPartsPer']==0 && $lossAssessment[0]['GSTAssessedPartsPer'] == $value)
         <td align="left" valign="top" colspan="{{ $dynamicColspan }}" style="padding: 0px 3px; border-left: 1px solid #000;">Total (Parts with GST {{ $value }}%)</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format($totalEstAmt, 2) }}</td>
    ...
    @foreach($lossAssessment as $row)
      ...
      @endif
        ...
        <tr>
          ...
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($lossAssessment[0]['totalFibreAmt'] * $lossAssessment[0]['FibreDepPer']) / 100, 2) }}
          </td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px;">0.00</td>
        ...
        <tr>
          ...
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">
          {{ number_format($lossAssessment[0]['totalFibreAmt'] - ($lossAssessment[0]['totalFibreAmt'] * $lossAssessment[0]['FibreDepPer']) / 100, 2) }}
          </td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">
    ...
    @if($totalIMT23MetalAmt !=0 || $totalIMT23RubberAmt != 0)
        <tr>
          <td align="left" valign="top" colspan="{{ $dynamicColspan }}" style="padding: 0px 3px; border-left: 1px solid #000;">
          Less Addl. Deduction of IMT Parts (*)- Metal - <span style="font-weight: bold;">{{ number_format($totalIMT23MetalAmt - ($totalIMT23MetalAmt * $lossAssessment[0]['MetalDepPer']) / 100, 2) }}</span> Rub/Plast - <span style="font-weight: bold;">{{ number_format($totalIMT23RubberAmt - ($totalIMT23RubberAmt * $lossAssessment[0]['RubberDepPer']) / 100, 2) }}</span> Fiber - <span style="font-weight: bold;">{{ number_format($totalIMT23FibreAmt - ($totalIMT23FibreAmt * $lossAssessment[0]['FibreDepPer']) / 100, 2) }}</span>
        </td>
          <td align="right" valign="top" style="padding: 0px 3px;">-</td>
          <td align="right" valign="top" style="padding: 0px 3px;">
            {{ number_format(($IMTMetalDepAmt * $lossAssessment[0]['IMT23DepPer']) / 100, 2) }}
          ...
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px;">
          {{ number_format(($IMTFibreDepAmt * $lossAssessment[0]['IMT23DepPer']) / 100, 2) }}
          </td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px;">0.00</td>
        ...
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($subTotalIMTGlassAmt, 2)}}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold;">{{ number_format($subTotalIMTFiberAmt, 2)}}</td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00") 
  ...
  @unless(in_array($value, $uniqueGstRates))
    ...
    @foreach($alldetails as $detail)
      ...
      @if(($lossAssessment[0]['GSTEstimatedPartsPer']==0 || $lossAssessment[0]['GSTEstimatedPartsPer'] == NULL) && ($lossAssessment[0]['GSTAssessedPartsPer'] !=0 || $lossAssessment[0]['GSTAssessedPartsPer'] != NULL))
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalGlassAmtAfterDep * $value / 100), 2) : '0.00' }}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
            <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalIMTFibreAmtAfterIMTDep * $value / 100), 2) : '0.00' }}</td>
          @endif
     ...
     @elseif(($lossAssessment[0]['GSTAssessedPartsPer']==0 || $lossAssessment[0]['GSTAssessedPartsPer'] == NULL) && ($lossAssessment[0]['GSTEstimatedPartsPer'] !=0 || $lossAssessment[0]['GSTEstimatedPartsPer'] != NULL))
      ...
      <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalGlassAmtAfterDep * $lossAssessment[0]['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
         @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          ...
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00")
            <td align="right" valign="top" style="padding: 0px 3px;">{{ number_format((($totalReconditionAmt + $totalPartReconditionAmt) * $value / 100), 2) }}</td>
          @endif
     @else
          <td align="left" valign="top" colspan="{{ $dynamicColspan }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add GST {{ $value }}%</td>
          <td align="right" valign="top" style="padding: 0px 3px;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($totalEstAmt * $value / 100), 2) : '0.00' }}</td>
     ...
     @if($lossAssessment[0]['GSTEstimatedPartsPer']==0 && $lossAssessment[0]['GSTEstimatedPartsPer'] == $value)
      ...
      <td align="left" valign="top" colspan="{{ $dynamicColspan }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add CGST {{ $value }}%</td>
          ...
          @if($lossAssessment[0]['MutipleGSTonParts']==1 && ($lossAssessment[0]['GSTAssessedPartsPer']!=0))
            ...
            @endif
            @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00")
            <td align="right" valign="top" style="padding: 0px 3px;">{{ $value != 0 ? number_format(($totalRecondtionGST * $value / 100), 2) : '0.00' }}</td>
          @endif
          @endif
      @endif
   </tr> -->
  ...
  @else
    @foreach($lossAssessment as $row)
       <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalGlassAmt']) ? number_format(($subTotalIMTGlassAmt * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
            <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalFibreAmt']) ? number_format(($subTotalIMTFiberAmt * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @endif
          
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00")
            <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalReconditionAmt']) ? number_format(($lossAssessment[0]['totalReconditionAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @endif
      </tr>
      <!-- <tr>
          @if($row['GSTEstimatedPartsPer'] == $row['GSTAssessedPartsPer'])
          ...
          @else
          <td align="left" valign="top" colspan="{{ $dynamicColspan }}" style="padding: 0px 3px; border-left: 1px solid #000;">Add CGST {{ $lossAssessment[0]['IGSTonPartsAndLab'] == 0 ? "GST" : "IGST" }} {{ $row['GSTEstimatedPartsPer'] }}%</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ !empty($lossAssessment[0]['total_EstAmt']) ? number_format(($lossAssessment[0]['total_EstAmt'] * $row['GSTEstimatedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">0.00</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">0.00</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">0.00</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">0.00</td>
          @endif
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalMetalAmt']) ? number_format(($lossAssessment[0]['totalMetalAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalRubberAmt']) ? number_format(($lossAssessment[0]['totalRubberAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalGlassAmt']) ? number_format(($lossAssessment[0]['totalGlassAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalFibreAmt']) ? number_format(($lossAssessment[0]['totalFibreAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00")
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000;">{{ !empty($lossAssessment[0]['totalReconditionAmt']) ? number_format(($lossAssessment[0]['totalReconditionAmt'] * $row['GSTAssessedPartsPer'] / 100), 2) : '0.00' }}</td>
          @endif
   ...
   <!-- Start Sub Total GST Part-->
      ...
      @endphp
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalGlassAmt + $subTotalIMTGlassAmt, 2)}}</td>
          @if($lossAssessment[0]['totalFibreAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalFibreAmt + $subTotalIMTFiberAmt, 2)}}</td>
          @endif
          @if($lossAssessment[0]['totalReconditionAmt'] !== "0.00") 
          <td align="right" valign="top" style="padding: 0px 3px; border-top: 1px solid #000; font-weight: bold;">{{ number_format($subTotalRecondAmt + (!empty($lossAssessment[0]['totalReconditionAmt']) ? $lossAssessment[0]['totalReconditionAmt'] : '0.00'),2)}}</td>
          @endif 
        </tr>
      <!-- End Sub Total GST Part-->
        <tr>
          ...
          <td align="right" valign="top" colspan="{{ ($maincolspan == 0) ? $dynamicColspan +1 : $maincolspan + 1 }}"
            style="padding: 0px 3px; border-bottom: 2px solid #000; border-top: 2px solid #000;font-weight: bold;">{{number_format($totalMetalAmt + $totalRubberAmt + $totalGlassAmt + $totalFibreAmt + $totalRecondAmt,2)}}</td>
