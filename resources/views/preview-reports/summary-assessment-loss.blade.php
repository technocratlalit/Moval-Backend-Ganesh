    ...
    <table width="100%" align="center" id="design" style="font-size: 12px;">
      <tbody>
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; width: 20%; font-weight: bold;">Estimated<br /><span style="font-weight: 400;">(Amt in Rs)</span></td>
          <td align="right" valign="top" style="padding: 0px 3px; width: 20%; font-weight: bold;">Assessed<br /><span style="font-weight: 400;">(Amt in Rs)</span></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="right" valign="top" style="font-weight: bold; border-top: 1px solid #000; padding: 0px 3px;">{{ ($lossAssessment[0]['totalestparts'] > 0) ? number_format_custom($lossAssessment[0]['totalestparts']) : '0.00' }}</td>
          <td align="right" valign="top" style="font-weight: bold; border-top: 1px solid #000; padding: 0px 3px;">{{ ($lossAssessment[0]['totalassparts'] > 0) ? number_format_custom($lossAssessment[0]['totalassparts']) : '0.00' }}
        </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px;">{{ ($lossAssessment[0]['netlabourAss'] > 0) ? number_format_custom($lossAssessment[0]['netlabourAss']) : '0.00'  }}
        </td>
        </tr>
        <tr>
          <td align="left" valign="top" style="padding: 0px 3px; font-weight: bold; border-left: 1px solid #000;">TOTAL</td>
          <td align="right" valign="top"  
            style="padding: 0px 3px; font-weight: bold; border-top: 2px solid #000;">{{ ($lossAssessment[0]['totalest'] > 0) ? number_format_custom($lossAssessment[0]['totalest']) : '0.00' }}</td>
          <td align="right" valign="top"  
            style="padding: 0px 3px; font-weight: bold; border-top: 2px solid #000;">{{ !empty($lossAssessment[0]['totalass']) ? number_format_custom($lossAssessment[0]['totalass']) : '0.00' }}</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="right" valign="top" style="padding: 0px 3px; font-weight: bold; border-bottom: 2px solid #000; padding: 0px 3px;">{{ ($lossAssessment[0]['alltotalass'] > 0) ? number_format_custom(round($lossAssessment[0]['alltotalass'])) : '0.00' }}</td>
        </tr>
